...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    $select_ar = "SELECT opis_aranzmana
     ...
     $polje_ar_c = [];
     $select_ar_c = "SELECT cijena
 		                FROM aranzman;";
      $result_ar_c = mysqli_query($conn,$select_ar_c);
      $resultCheck = mysqli_num_rows($result_ar_c);
      if ($resultCheck > 0){
        while ($row = mysqli_fetch_assoc($result_ar_c)){
          array_push($polje_ar_c,$row['cijena']);
        }
      }
    ...
    $select_du = "SELECT naziv
     ...
     $polje_du_c = [];
     $select_du_c = "SELECT cijena
 		                FROM dodatne_usluge;";
      $result_du_c = mysqli_query($conn,$select_du_c);
      $resultCheck = mysqli_num_rows($result_du_c);
      if ($resultCheck > 0){
        while ($row = mysqli_fetch_assoc($result_du_c)){
          array_push($polje_du_c,$row['cijena']);
        }
      }
     $polje_du_id = [];
     $select_du_id = "SELECT id_dodatne_usluge
      ...
      $polje_s_c = [];
      $select_sgl_soba_c = "SELECT standardna_cijena FROM soba LEFT OUTER JOIN rezervacija ON rezervacija.id_soba = soba.id_soba
      WHERE
          vrsta = 'SGL' AND
          ((((pocetak_rezervacije > '$odabrani_dd2') AND (pocetak_rezervacije > '$odabrani_do2')) OR ((kraj_rezervacije < '$odabrani_dd2')
           AND (kraj_rezervacije < '$odabrani_do2'))) OR id_rezervacija IS NULL); ";
      $result_sgl_soba_c = mysqli_query($conn,$select_sgl_soba_c);
      $resultCheck = mysqli_num_rows($result_sgl_soba_c);
      if ($resultCheck > 0){
        while ($row = mysqli_fetch_assoc($result_sgl_soba_c)){
          array_push($polje_s_c,$row['standardna_cijena']);
        }
      }
       ...
       WHERE
        ...
        $polje_s1_c = [];
        $select_dbl_soba_c = "SELECT standardna_cijena FROM soba LEFT OUTER JOIN rezervacija ON rezervacija.id_soba = soba.id_soba
        WHERE
            vrsta = 'DBL' AND
            ((((pocetak_rezervacije > '$odabrani_dd2') AND (pocetak_rezervacije > '$odabrani_do2')) OR ((kraj_rezervacije < '$odabrani_dd2')
             AND (kraj_rezervacije < '$odabrani_do2'))) OR id_rezervacija IS NULL); ";
         $result_dbl_soba_c = mysqli_query($conn,$select_dbl_soba_c);
         $resultCheck = mysqli_num_rows($result_dbl_soba_c);
         if ($resultCheck > 0){
           while ($row = mysqli_fetch_assoc($result_dbl_soba_c)){
             array_push($polje_s1_c,$row['standardna_cijena']);
           }
         }
        ...
        WHERE
         ...
         $polje_s3_c = [];
         $select_twin_soba_c = "SELECT standardna_cijena FROM soba LEFT OUTER JOIN rezervacija ON rezervacija.id_soba = soba.id_soba
         WHERE
             vrsta = 'TWIN' AND
             ((((pocetak_rezervacije > '$odabrani_dd2') AND (pocetak_rezervacije > '$odabrani_do2')) OR ((kraj_rezervacije < '$odabrani_dd2')
              AND (kraj_rezervacije < '$odabrani_do2'))) OR id_rezervacija IS NULL); ";
          $result_twin_soba_c = mysqli_query($conn,$select_twin_soba_c);
          $resultCheck = mysqli_num_rows($result_twin_soba_c);
          if ($resultCheck > 0){
            while ($row = mysqli_fetch_assoc($result_twin_soba_c)){
              array_push($polje_s3_c,$row['standardna_cijena']);
            }
          }
         ...
         WHERE
          ...
          $polje_s4_c = [];
          $select_trpl_soba_c = "SELECT standardna_cijena FROM soba LEFT OUTER JOIN rezervacija ON rezervacija.id_soba = soba.id_soba
          WHERE
              vrsta = 'TRPL' AND
              ((((pocetak_rezervacije > '$odabrani_dd2') AND (pocetak_rezervacije > '$odabrani_do2')) OR ((kraj_rezervacije < '$odabrani_dd2')
               AND (kraj_rezervacije < '$odabrani_do2'))) OR id_rezervacija IS NULL); ";
           $result_trpl_soba_c = mysqli_query($conn,$select_trpl_soba_c);
           $resultCheck = mysqli_num_rows($result_trpl_soba_c);
           if ($resultCheck > 0){
             while ($row = mysqli_fetch_assoc($result_trpl_soba_c)){
               array_push($polje_s4_c,$row['standardna_cijena']);
             }
           }
          ...
          WHERE
           ...
           $polje_s5_c = [];
           $select_qdpl_soba_c = "SELECT standardna_cijena FROM soba LEFT OUTER JOIN rezervacija ON rezervacija.id_soba = soba.id_soba
           WHERE
               vrsta = 'QDPL' AND
               ((((pocetak_rezervacije > '$odabrani_dd2') AND (pocetak_rezervacije > '$odabrani_do2')) OR ((kraj_rezervacije < '$odabrani_dd2')
                AND (kraj_rezervacije < '$odabrani_do2'))) OR id_rezervacija IS NULL); ";
            $result_qdpl_soba_c = mysqli_query($conn,$select_qdpl_soba_c);
            $resultCheck = mysqli_num_rows($result_qdpl_soba_c);
            if ($resultCheck > 0){
              while ($row = mysqli_fetch_assoc($result_qdpl_soba_c)){
                array_push($polje_s5_c,$row['standardna_cijena']);
              }
            }
        //fetch $drzava
        $odabrana_drzava = '';
...
<script type="text/JavaScript">
      ...
      function gost_provjera(){
        ...
        var x3_b = x3.replace(/[0-9]/g, '');

        if(x1=='' || x2==''|| x3==''|| x4==''|| x5==''|| x1_b!=''|| x2_b!=''|| x3_b!=''){
      ...
      function gost() {
        ...
        var datum = [];
          ...
          for(var i = 0; i < gost_id.length; i++) {
              ...
              var j = i+1;
              $(".gosti").append(
                  '<form name="remove_gost'+gost_id[i]+'" action="gost_gost_izbrisan.php" method="POST"><p><b>' + j + '.</b> ' + ime[i] + ', ' + prezime[i]+ ', ' + '<b>OIB:</b> ' + oib[i] + ', '+ '<b>Broj osobne iskaznice:</b> ' + boi[i] + ', '+ '<b>Datum rođenja:</b> ' + datum[i] +
      ...
      function mjestoPrebivalista() {
        ...
        function datum() {
          ...
          if (dolazak !='' || odlazak!= '') {
            ...
            document.getElementById("trajanje").innerHTML = trajanje;
          ...
          window.onload = function on_load_prikaz() {
            ...
            while (selectListAranzman.lastElementChild) {
              ...
              var array4 = [];
              array4 = <?php echo (json_encode($polje_ar_c));?>;
              for (var i = 0; i < array3.length; i++) {
                  var option = document.createElement("option");
                  option.value = array3[i];
                  option.name = "aranzman_stavka";
                  option.text = array3[i] + " | " + array4[i] + " kn";
        ...
        var array2 = [];
        array2 = <?php echo (json_encode($polje_s_c));?>;
        for (var i = 0; i < array.length; i++) {
            var option = document.createElement("option");
            option.value = array[i];
            option.name = "soba_stavka";
            option.text = "Šifra: " + array[i] + " | " + array2[i] + " kn";
...
//----------------------------------------------------------------
        ...
        array3 = <?php echo (json_encode($polje_du_c));?>;
        ...
        for (var i =0; i < array2.length; i++){
          ...
          label.id = "label_" + i;
          label.for = (i);
          label.innerHTML = "<b> "+array2[i] + " | " + array3[i] + " kn";"</b>";

          input.setAttribute("onchange", 'dodatne_usluge_kolicina(this.id); izracunCijene();');
          ...
          function dodatne_usluge_kolicina(chckbox_id){
            ...
            if (checkbox.checked) {
              ...
              kolicina.min = "1";
              kolicina.value= 1;
              kolicina.setAttribute("onchange", 'izracunCijene()');
          ...
          function prikaz_soba(vrijednost){
            ...
            // soba 2
              ...
              var array2 = [];
              array2 = <?php echo (json_encode($polje_s1_c));?>;
              for (var i = 0; i < array.length; i++) {
                  var option = document.createElement("option");
                  option.value = array[i];
          ...
          var array2 = [];
          array2 = <?php echo (json_encode($polje_s3_c));?>;
          for (var i = 0; i < array.length; i++) {
              var option = document.createElement("option");
              option.value = array[i];
              option.name = "odabir_soba";
          ...
          var array2 = [];
          array2 = <?php echo (json_encode($polje_s4_c));?>;
          for (var i = 0; i < array.length; i++) {
              var option = document.createElement("option");
              option.value = array[i];
              option.name = "odabir_soba";
          ...
          var array2 = [];
          array2 = <?php echo (json_encode($polje_s5_c));?>;
          for (var i = 0; i < array.length; i++) {
              var option = document.createElement("option");
              option.value = array[i];
              option.name = "odabir_soba";
